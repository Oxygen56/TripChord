...
2. [系统架构](architecture.md)：模型角色和普通程序怎样分工；
3. [重要架构决策](architecture-decisions.md)：为什么这样设计，以及哪些方案已经比较后没有采用；
4. [产品形态与实施路线](roadmap.md)：完整产品要做到什么，下一步按什么顺序实施；
5. [1.0 桌面核心验收](v1.0-acceptance.md)：当前版本已经实际完成到哪里。
