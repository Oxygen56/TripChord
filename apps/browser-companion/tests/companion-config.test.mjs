...
assert.match(files[0], /MAX_CONCURRENT_LEASES - activeLeaseIds\.size/);
assert.match(files[0], /limit: availableLeaseSlots/);
...
assert.match(files[0], /"renewable_server_lease"/);
assert.match(files[0], /"server_absolute"/);
